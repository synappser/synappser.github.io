...
| ------- | -------- | ------------- | ----------|
v0.7.7 | [Public Beta](https://github.com/synappser/FinderFix/releases/download/v0.7.7/FinderFix_v0.7.7b.dmg) | [Release notes]({{ site.url }}{% link releases/finderfix_v0.7.7.md %}) | macOS 11.0 |
v0.7.6 | Public Beta | [Release notes]({{ site.url }}{% link releases/finderfix_v0.7.6.md %}) | macOS 11.0 |
 v0.7.5 | Public Beta | [Release notes]({{ site.url }}{% link releases/finderfix_v0.7.5.md %}) | macOS 11.0 |
...
| Version | Download | Release notes | Minimum OS|
| ------- | -------- | ------------- | ----------|
| v0.5.8 | [Public Beta](https://github.com/synappser/TrashEye/releases/download/v0.5.8/TrashEye_v0.5.8b.dmg) | [Release notes]({{ site.url }}{% link releases/trasheye_v0.5.8.md %}) | macOS 11.0  |
| v0.5.7 | Public Beta | [Release notes]({{ site.url }}{% link releases/trasheye_v0.5.7.md %}) | macOS 11.0  |
